...
<div class="main_content">
   <div class="table_allign">
    ...
    <tr>
        ...
        <td><button class="actions"><a href="{{url('/download'. $row->content_file)}}">Download</a></button>
        <br><br>
        <button class="actions"><a href={{'course_content_delete'.$row->content_id}}>Delete</a></button>
        <br><br>
        <button class="actions"><a href={{'edit_course_content/'.$row->content_id}}>Edit Post</a></button></td>
